...
function startTyping() {
    // Reset fact and character indices
    currentFactIndex = 0;
    currentCharacterIndex = 0;

    // Reset the display style to 'block' when starting typing
    const factTextElement = document.getElementById("factTextDiv");
    factTextElement.style.display = 'block';

    // Call the function to type the initial fact
    typeFact();
}
